...
//    }
    ...
    func setupFrameSides() {
        ...
        //TOP
        let v0 = SCNVector3(-w/2, r+h, -l/2)
        let v3 = SCNVector3(-w/2-h, r+h+h, 0)
        let v1 = SCNVector3(w/2, r+h, -l/2)
        let v2 = SCNVector3(w/2+h, r+h+h, 0)
        
        let v4 = SCNVector3(-w/2, r+h, -l)
        let v6 = SCNVector3(-w/2-h, r+h+h, -l)
        let v5 = SCNVector3(w/2, r+h, -l)
        let v7 = SCNVector3(w/2+h, r+h+h, -l)
        ...
        //BOT
        let v18 = SCNVector3(-w/2, -r-h, -l/2)
        let v16 = SCNVector3(-w/2-h, -r-h-h, 0)
        let v19 = SCNVector3(w/2, -r-h, -l/2)
        let v17 = SCNVector3(w/2+h, -r-h-h, 0)

        let v22 = SCNVector3(-w/2, -r-h, -l)
        let v20 = SCNVector3(-w/2-h, -r-h-h, -l)
        let v23 = SCNVector3(w/2, -r-h, -l)
        let v21 = SCNVector3(w/2+h, -r-h-h, -l)
        ...
        let material = SCNMaterial().then {
            $0.isDoubleSided = true
            $0.diffuse.contents = UIImage(named: "wood")
//            $0.normal.contents = UIImage(named: "SilverNormal")
//            $0.roughness.contents = UIImage(named: "SilverRoughness")
//
